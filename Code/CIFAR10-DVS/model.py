...
def _safe_construct(cls, **kwargs):
    """Construct a SpikingJelly neuron across several API versions."""
    try:
        return cls(**kwargs)
    except TypeError:
        kwargs = dict(kwargs)
...
class ALSMCIFAR10DVS(nn.Module):
    def __init__(
        self,
        *,
        img_size: int = 128,
...
def alsm_cifar10dvs(**kwargs) -> ALSMCIFAR10DVS:
    return ALSMCIFAR10DVS(**kwargs)


__all__ = ["ALSMCIFAR10DVS", "alsm_cifar10dvs"]
