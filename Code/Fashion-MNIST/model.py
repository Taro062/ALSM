...
class SpikformerLSM_Interactive(nn.Module):
    def __init__(self, img_size_h=28, img_size_w=28, patch_size=4, in_channels=1, num_classes=10,
                 embed_dims=128, num_heads=4, mlp_ratios=4, drop_path_rate=0.1, depths=2, T=6):
        super().__init__()
        self.T = T
