...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.xxxxxxx.svg)](https://doi.org/10.5281/zenodo.xxxxxxx) > **Note to Readers**: This code is directly related to the manuscript currently submitted to **The Visual Computer**. Please cite this relevant manuscript if you use our code for your research.
